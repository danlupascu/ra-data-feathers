  ...
  var mapRequest = function mapRequest(type, resource, params) {
    ...
    switch (type) {
      ...
      case _reactAdmin.UPDATE:
        if (usePatch) {
          var data = params.previousData ? (0, _deepObjectDiff.diff)(params.previousData, params.data) : params.data;
      ...
      case _reactAdmin.UPDATE_MANY:
        if (usePatch) {
          var _data2 = params.previousData ? (0, _deepObjectDiff.diff)(params.previousData, params.data) : params.data;
